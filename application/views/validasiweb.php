	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<ul class="navbar-nav me-auto mb-2 mb-md-0">
				...
				<li class="nav-item">
					<a class="nav-link active" href="#" aria-current="page" >Validation</a>
				</li>
			</ul>
		</div>
	</div>
...
<main class="container d-flex justify-content-center">
	<div class="card col-lg-6">
		...
		<div class="card-body">
			<form id="form-validasi" action="<?php echo base_url('validation'); ?>" method="post" enctype="multipart/form-data">
				<div class="mb-3">
...
<script>
	const form = document.querySelector('#form-validasi');
